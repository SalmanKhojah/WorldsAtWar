...
namespace DeadRevolver.PixelPrototypePlayer {
    ...
    public class AnimationMainManager : MonoBehaviour {
        public GameObject previewPlayer;
        public GameObject previewPlayer2;
        ...
        void Start() {
            _anim2 = previewPlayer2.GetComponent<Animator>();
        ...
        private void UpdateAnimation() {
            ...
            _anim2.Play(currentAnimation.animationName);
            onAnimationChanged.Invoke(currentAnimation, _currentAnimation, animations);
            Debug.Log("Updating animation to: " + currentAnimation.animationName);
